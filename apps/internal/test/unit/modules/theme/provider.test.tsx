...
describe('ThemeProvider', () => {
  ...
  it('persists the chosen theme to localStorage', () => {
    ...
    act(() => api?.setTheme('dark'))
    expect(window.localStorage.getItem('internal:theme')).toBe('dark')

    act(() => api?.setTheme('system'))
    expect(window.localStorage.getItem('internal:theme')).toBe('system')
  })

  it('reads the persisted theme on mount', () => {
    installMatchMedia(false) // OS = light
    window.localStorage.setItem('internal:theme', 'dark')
