...
// Periodic proof-of-life. Emits a `worker.heartbeat` event every 30s; the
// heartbeat subscriber logs it. Smoke checks tail the log for a recent entry
// to assert the worker is alive end-to-end (schedule registered → BullMQ
